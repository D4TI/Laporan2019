...
\begin{itemize}
\item Dedikasi
\subitem Keleketex\#74
\item Produktif
  \subitem Mempelajari Gitlab
  \subitem Bimbingan dengan Bu Nuraini
  \subitem Konsultasi dengan Pak Yusril mengenai Internship II dan TA
  \subitem Izin pulang cepat lebih dulu
\item Integritas
  \subitem Tidak ada penolakan dalam Pull Request
\item Disiplin
  \subitem Jam Masuk : 08.58 wib
  \subitem Jam Pulang :15.51 wib
\item Loyalitas
  \subitem Membelikan makanan untuk dosen
  \subitem Membereskan sampah dimeja pak kamal
\end{itemize}
